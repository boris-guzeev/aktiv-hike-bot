...
VALUES
    ...
    ('100K', 'Суммарная дистанция 100 км, пройденная с AktivHike.'),
    ('250K', 'Суммарная дистанция 250 км, пройденная с AktivHike.'),
    ('500K', 'Суммарная дистанция 500 км, пройденная с AktivHike.'),
    ('1000K', 'Суммарная дистанция 1000 км, пройденная с AktivHike.'),
